...
void myCallback_goal_rviz(geometry_msgs::PoseStamped goal){
    if(type_from_rviz == 0){
        ...
        vector<int> gridXY;
        gridXY = astar.coord_to_grid(coord);
        astar.starting_point = *new A_star::cell(gridXY[0],gridXY[1],gridXY[1]*astar.my_map.info.width+gridXY[0],coord[0],coord[1],0,0) ;//8153962 8217882 shit:8217882 x:1882 y:2054        astar.starting_point.g = 0;
        ...
        vector<int> gridXY;
        gridXY = astar.coord_to_grid(coord);
        astar.goal = *new A_star::cell(gridXY[0],gridXY[1],gridXY[1]*astar.my_map.info.width+gridXY[0],coord[0],coord[1],-1,-1) ;//8153962 8217882 shit:8217882 x:1882 y:2054
...
//        Hastar.set_start_end();
	    ...
	    astar.A_star_search();
            ...
            Initmarker(astar.starting_point,100);
            Initmarker(astar.goal,2000);
            pub_inf.publish(astar.close_list_map_);
            cout << " size of path :" << astar.path.size() << endl;
